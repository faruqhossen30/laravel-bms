         ...
         <div class="col-md-6 mb-2">
            <div class="live_match">
               ...
               <div class="live_match_list">
                  ...
                  @endphp
                  <div class="card game filter {{ strtolower(str_replace(' ', '-', $match->match_type)) }}">
                     <div class="card-header" id="heading{{ $match->id }}">
                        <button class="btn btn-link match-open" type="button" data-match="{{ $match->id }}">
                           <div class="panel-title">
                              <div class="panel-title-img">
                                 @if($match->match_type == 'FootBall')
                                 <img src="{{ asset('static/images/game_icon/football-play-match.png') }}" alt="FootBall">
                                 @elseif($match->match_type == 'Cricket')
                                 <img src="{{ asset('static/images/game_icon/cricket-logo.png') }}" alt="Cricket">
                                 ...
                                 <img src="{{ asset('static/images/game_icon/ludo.png') }}" alt="Ludo">
                              ...
                              <div class="panel-title-right">
                                 <h5>{{ $match->team_one }} <img src="{{ asset('static/images/vs.png') }}" alt="VS"> {{ $match->team_two }} </h5>
                                 <p>{{ $match->bet_statement }}
                                    <br>
                                    <span><img src="{{ asset('static/images/calander.png') }}" style="width: 15px;" alt="Calander"> 
                                    {{ $date }} 
                                    <img src="{{ asset('static/images/clock.png') }}" style="width: 15px;" alt="Clock"> 
                                    {{ $time }}
                                    </span>
                                    <br>
                                    <img class="live-gif" src="{{ asset('static/images/live.gif') }}" alt="Live">
                                 </p>
                              </div>
                           </div>
                        </button>
                     ...
                     <div class="match-open-{{ $match->id }}">
                        ...
                        <div id="collapse{{ $match->id }}" class="collapse show" aria-labelledby="heading{{ $match->id }}" data-parent="#accordionExample">
                           @foreach($match->questions as $key => $question)
                           @if($question->status == 'active' && $question->is_hide == '0')
                           <div class="card-body">
                              <div class="panel-heading second-lebal">
                                 <h4 style="cursor: pointer" class="panel-title-2" role="button" data-toggle="collapse" href="#one{{ $question->id }}" aria-expanded="true" aria-controls="#one{{ $question->id }}">
                                    {{ $question->name }}
                                 </h4>
                              </div>
                              <div id="one{{ $question->id }}" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="">
                                 <div class="panel-body">
                                    <div class="container">
                                       <div class="row">
                                          ...
                                          <div class="col btn btn-default data-show buttonrate">
                                             <div class="rate_s {{ $match->is_active == '1' && $question->is_active == '1' ? 'betInfo' : '' }}" data-id="{{ $option->id }}">
                                                <span class="option">{{ $option->name }}<br/>
                                                <span class="option-ratio"><b>
                           ...
                           <div class="panel-title">
                              ...
                              <div class="panel-title-right">
                                 ...
                                 <p>{{ $match->bet_statement }}
                                    ...
                                    <br>
                                    <img class="live-gif" src="{{ asset('static/images/upcoming.png') }}" alt="Upcoming">
                                 </p>
                              </div>
                           </div>
                        </button>
