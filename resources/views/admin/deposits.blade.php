...
<form action="{{ url('tib-admin/deposits')}}" method="get">
...
<td>
@if($row->status== 'pending')
<a href="javascript:void(0)" id="deposit-accept" data-id="{{ $row->id }}">
<button type="button" class="btn btn-primary btn-sm">
<i class="fas fa-check"></i>
</button>
</a>
<a href="javascript:void(0)" id="deposit-cancel" data-id="{{ $row->id }}">
