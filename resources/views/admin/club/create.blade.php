...
<div class="card-body">
<form method="post" action="{{ url('tib-admin/club') }}">
@csrf
<div class="row">
<div class="col-md-6">
...
<input type="text" class="form-control @error('club_owner') is-invalid @enderror" id="club_owner" name="club_owner" value="{{ old('club_owner') }}" placeholder="Club Owner" required="">
@error('club_owner')
<span class="invalid-feedback" role="alert">
<strong>{{ $message }}</strong>
</span>
...
<input type="text" class="form-control @error('club_mobile') is-invalid @enderror" id="club_mobile" name="club_mobile" value="{{ old('club_mobile') }}" placeholder="Club Mobile" required="">
@error('club_mobile')
<span class="invalid-feedback" role="alert">
<strong>{{ $message }}</strong>
</span>
...
<input type="text" class="form-control @error('club_address') is-invalid @enderror" id="club_address" name="club_address" value="{{ old('club_address') }}" placeholder="Club Address" required="">
@error('club_address')
<span class="invalid-feedback" role="alert">
<strong>{{ $message }}</strong>
</span>
...
<input type="number" class="form-control @error('club_commission') is-invalid @enderror" step="any" id="club_commission" value="{{ old('club_commission') }}" name="club_commission" placeholder="Club Commission" required="">
