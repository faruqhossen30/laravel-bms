    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <form action="{{ url('tib-admin/balance-transfers/system/on-off')}}" method="post">
                    @csrf
                    <input name="balance_transfer" type="checkbox" @if($balance_transfer == 'on') checked @endif data-toggle="toggle"  data-onstyle="success" onchange="this.form.submit()">
                </form>
            </div>
