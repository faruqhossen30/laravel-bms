<div class="tab-pane fade" id="ClubWithdraw">
<div class="card">
        ...
        <div class="card-body p-2">
            ...
            <form method="POST" action="{{ route('user.storeWithdraw') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="amount" class="form-control" step="any" min="50" max="10000" value="" placeholder="Enter ammount" required="">
                </div>
