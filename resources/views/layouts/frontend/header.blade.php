    ...
    <div class="flex h-14 px-2 bg-emerald-800 border-b-2 border-emerald-600 ">
        ...
        <div class="flex justify-end sm:justify-end md:justify-between flex-grow items-center">
            ...
            <div class="space-x-2">
                ...
                @guest
                    <button type="button"
                        class="inline-block px-2 sm:px-6 sm:py-2.5 py-1 bg-white text-emerald-800 sm:font-bold text-xs leading-tight uppercase rounded shadow-md hover:bg-yellow-700 hover:shadow-lg focus:bg-yellow-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-yellow-800 active:shadow-lg transition duration-150 ease-in-out"
