        ...
        <div class="flex justify-center ">
            <div class="block rounded-lg shadow-lg bg-white min-w-full">
                ...
                <div class="p-2 grid grid-cols-12 gap-4">
                    <div class="col-span-12 md:col-span-4 bg-green-100 flex justify-between place-items-center">
                    ...
                    <div class="col-span-12 md:col-span-4 bg-green-100 flex justify-between place-items-center">
                        <div class="p-3 text-center">
                            <span class="font-bold">{{ $betCount }}</span> <br>
                            <span class="text-orange-700 ">Total Bet</span>
                        </div>
                        <div>
                            <span class="text-3xl p-4 text-emerald-700"><i class="fas fa-gamepad"></i></span>
                        </div>
                    </div>
                    <div class="col-span-12 md:col-span-4 bg-green-100 flex justify-between place-items-center">
                        <div class="p-3 text-center">
                            <span class="font-bold">{{ $winCount }}</span> <br>
                            <span class="text-orange-700">Total Win</span>
                        </div>
                        <div>
                            <span class="text-3xl p-4 text-emerald-700"><i class="fas fa-trophy"></i></span>
                        </div>
                    </div>
                </div>
                <div class="py-3">
